...
(function (w) {
  var KEY = "smilecare.v1", EV = "smilecare:change";
  var LISTS = ["days","slots","stats","cats","procs","packages","steps","why","gallery","reviews","faq"];
  function clone(o) { return JSON.parse(JSON.stringify(o)); }
  function seed() { return clone(w.SC_SEED); }
  ...
  function read() {
    ...
    db.fear = Object.assign({}, s.fear, db.fear || {});
