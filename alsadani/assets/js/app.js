(function () {
  ...
  var HI = "السلام عليكم مول السعدني ✦";

  /* رسمة بديلة للمنتج غير المصوّر */
  var ART = {
    beds:'<path d="M3 20v-8a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v8"/><path d="M3 16h18"/><path d="M7 10V7.5A1.5 1.5 0 0 1 8.5 6h2A1.5 1.5 0 0 1 12 7.5V10"/><path d="M13 10V7.5A1.5 1.5 0 0 1 14.5 6h1A1.5 1.5 0 0 1 17 7.5V10"/>',
    blankets:'<path d="M3 8a3 3 0 0 1 3-3h12a3 3 0 0 1 3 3v11H3z"/><path d="M3 12h18M8 5v14M13 5v14M18 5v14"/>',
    quilts:'<rect x="3" y="5" width="18" height="14" rx="2"/><path d="M3 10h18M9 5v14M15 5v14"/>',
    towels:'<path d="M6 3h12a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"/><path d="M8 7h8M8 11h8M8 15h5"/>'
  };
  ...
  function offerCard(o, big) {
    ...
    return '<article class="offer' + (big ? " big" : "") + '" data-id="' + esc(o.id) + '">' +
      ...
      "</div>" +
      '<div class="pcs">' + esc(eg(c.pcs)) + " قطعة في العرض</div>" +
  ...
  function addItem(p) {
    ...
    toast("اتضاف للقايمة — " + list.reduce(function (a, c) { return a + c.q; }, 0) + " قطعة");
  }
  function paintList() {
  ...
  all();
  SStore.on(function () { db = SStore.get(); all(); });
})();
