(function () {
  ...
  var HI = "السلام عليكم شوكة وسكينة ✦";

  /* رسمة بديلة للمنتج غير المصوّر */
  var ART = {
    pots:'<path d="M4 9h16v8a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3z"/><path d="M2.5 11.5h1.5M20 11.5h1.5"/><path d="M7 9V7.5h10V9"/><path d="M12 4v2"/>',
    porcelain:'<circle cx="12" cy="12" r="8.5"/><circle cx="12" cy="12" r="4"/>',
    kettles:'<path d="M6 10h11v7a3 3 0 0 1-3 3H9a3 3 0 0 1-3-3z"/><path d="M17 12.5h3.5l-2-3.5"/><path d="M8 10V8a3.5 3.5 0 0 1 7 0v2"/><path d="M11.5 4.5h1.5"/>',
    tools:'<path d="M8 3v7a3 3 0 0 0 6 0V3"/><path d="M11 13v8"/><path d="M17.5 3c1.8 1.5 2.4 4.5 1.4 7l-1.4 2v9"/>'
  };
  ...
  all();
  FStore.on(function () { db = FStore.get(); all(); });
})();
